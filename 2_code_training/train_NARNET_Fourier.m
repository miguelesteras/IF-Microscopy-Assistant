...
perf_Fourier = mat2str([netPerf ones(size(netPerf))*basePerf]);
save('perf_Fourier.mat','perf_Fourier')
...
perf_Fourier = mat2str([netPerf ones(size(netPerf))*basePerf]);
save('perf_Fourier_1to50Epochs.mat','perf_Fourier')
save('net_Fourier_narnet_50epochs.mat','net')
