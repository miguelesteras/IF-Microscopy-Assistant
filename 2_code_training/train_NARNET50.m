...
for m = 1:epochs
    % check progress
    save('progress_narnet50_rho.mat','m','-ascii')
...
save('perf_Rho_Narnet50.mat','record')
save('net_Rho_Narnet50.mat','net')
...
for m = 1:epochs
    % check progress
    save('progress_narnet50_fourier.mat','m','-ascii')
...
record = mat2str([netPerf ones(size(netPerf))*basePerf]);
save('perf_Fourier_Narnet50.mat','record')
save('net_Fourier_Narnet50.mat','net')
...
for m = 1:epochs
    % check progress
    save('progress_narnet50_boundary.mat','m','-ascii')
...
record = mat2str([netPerf ones(size(netPerf))*basePerf]);
save('perf_Boundary_Narnet50.mat','record')
save('net_Boundary_Narnet50.mat','net')