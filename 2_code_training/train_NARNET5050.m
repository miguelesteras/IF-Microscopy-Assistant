...
for m = 1:epochs
    % check progress
    save('progress_narnet5050_rho.mat','m','-ascii')
...
save('perf_Rho_Narnet5050.mat','record')
save('net_Rho_Narnet5050.mat','net')
...
for m = 1:epochs
    % check progress
    save('progress_narnet5050_fourier.mat','m','-ascii')
...
record = mat2str([netPerf ones(size(netPerf))*basePerf]);
save('perf_Fourier_Narnet5050.mat','record')
save('net_Fourier_Narnet5050.mat','net')
...
for m = 1:epochs
    % check progress
    save('progress_narnet5050_boundary.mat','m','-ascii')
...
record = mat2str([netPerf ones(size(netPerf))*basePerf]);
save('perf_Boundary_Narnet5050.mat','record')
save('net_Boundary_Narnet5050.mat','net')